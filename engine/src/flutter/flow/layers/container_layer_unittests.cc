...
TEST_F(ContainerLayerDiffTest, PictureLayerInsertion) {
  ...
  EXPECT_EQ(damage.frame_damage.bounds(), DlIRect::MakeLTRB(0, 0, 150, 50));
  ...
  EXPECT_EQ(damage.frame_damage.bounds(), DlIRect::MakeLTRB(200, 0, 250, 50));
...
TEST_F(ContainerLayerDiffTest, LayerDeletion) {
  ...
  auto damage = DiffLayerTree(t1, MockLayerTree());
  EXPECT_EQ(damage.frame_damage.bounds(), DlIRect::MakeLTRB(0, 0, 250, 50));
  ...
  damage = DiffLayerTree(t2, t1);
  EXPECT_EQ(damage.frame_damage.bounds(), DlIRect::MakeLTRB(0, 0, 50, 50));
  ...
  damage = DiffLayerTree(t3, t1);
  EXPECT_EQ(damage.frame_damage.bounds(), DlIRect::MakeLTRB(100, 0, 150, 50));
  ...
  EXPECT_EQ(damage.frame_damage.bounds(), DlIRect::MakeLTRB(100, 0, 250, 50));
...
TEST_F(ContainerLayerDiffTest, ReplaceLayer) {
  ...
  damage = DiffLayerTree(t3, t1);
  EXPECT_EQ(damage.frame_damage.bounds(), DlIRect::MakeLTRB(0, 0, 50, 150));
  ...
  damage = DiffLayerTree(t4, t1);
  EXPECT_EQ(damage.frame_damage.bounds(), DlIRect::MakeLTRB(100, 0, 150, 150));
  ...
  damage = DiffLayerTree(t5, t1);
  EXPECT_EQ(damage.frame_damage.bounds(), DlIRect::MakeLTRB(200, 0, 250, 150));
}
