...
bool RenderToTarget(ContentContext& context,
  ...
  return RenderToTarget(context, render_target, display_list, cull_bounds,
                        reset_host_buffer, is_onscreen);
}
