...
inline constexpr uint32_t kPipelineCacheSchemaVersionVK = 2u;
inline constexpr uint32_t kImpellerPipelineCacheABIVersionVK = 1u;
...
struct PipelineCacheHeaderVK {
  ...
  // Increment whenever the serialized Impeller wrapper changes.
  uint32_t schema_version = kPipelineCacheSchemaVersionVK;
  // Increment whenever Impeller pipeline-generation semantics make an old
  // Vulkan cache unsafe to consume, independently of the wrapper schema.
  uint32_t impeller_abi = kImpellerPipelineCacheABIVersionVK;
