...
class TextFrame {
 public:
  ...
  void SetCoverageMode(CoverageMode value) { coverage_mode_ = value; }
  CoverageMode GetCoverageMode() const { return coverage_mode_; }
 ...
 private:
  ...
  CoverageMode coverage_mode_ = CoverageMode::kPlatformDefault;
};
